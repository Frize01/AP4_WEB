    ...
    <body class="bg-snowgray">
        ...
        <footer class="p-4 bg-[{{$couleur}}] sm:p-6 dark:bg-gray-900 sticky top-[100vh]">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="http://127.0.0.1:8000/" class="flex items-center">
                        ...
                        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ration</span>
                    </a>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://127.0.0.1" class="hover:underline">Ration™</a>. Tout droits réservés.
                </span>
